...
## added by Jiarui
depth_images= EasyDict()                                    # Options for load depth images
## end added by Jiarui
...
desc += '-576rgbimages';          dataset = EasyDict(tfrecord_dir='rgbd_tfrecord'); depth_images = EasyDict(tfrecord_dir='depth_tfrecord'); train.mirror_augment = True
...
desc += '-preset-v2-2gpus'; num_gpus = 2; sched.minibatch_base = 4; sched.minibatch_dict = {4: 128, 8: 128, 8: 64, 32: 32, 64: 16, 128: 8, 256: 4}; sched.G_lrate_dict = {512: 0.0015, 1024: 0.002}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 12000
...
# Special modes.
desc += '-BENCHMARK'; sched.lod_initial_resolution = 4; sched.lod_training_kimg = 3; sched.lod_transition_kimg = 3; train.total_kimg = 3904; sched.tick_kimg_base = 1; sched.tick_kimg_dict = {}; train.image_snapshot_ticks = 10; train.network_snapshot_ticks = 1000
#desc += '-BENCHMARK0'; sched.lod_initial_resolution = 1024; train.total_kimg = 8; sched.tick_kimg_base = 1; sched.tick_kimg_dict = {}; train.image_snapshot_ticks = 1000; train.network_snapshot_ticks = 1000
